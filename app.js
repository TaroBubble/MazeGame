/* 
1. World - Object that contains all of the different things in our matter app
2. Engine - Reads the current state of the world from the world object, then calculates the changes of those states
3. Runner - Gets the engine and world running together, runs roughly 60 times/ sec
4. Render - Whenever the engine processes an update, render looks at all the shapes and show them on the screen
5. Body - A shape we are currently showing
*/

/*
    display 3 different game modes, easy, medium, hard
    redo color and styling on landing page
    after game is finished display retry or next level
 */
const easyGame = document.querySelector('.button');
easyGame.addEventListener('click', () => {
    //hide the top
    document.querySelector('.hero').classList.add('is-hidden-desktop');
